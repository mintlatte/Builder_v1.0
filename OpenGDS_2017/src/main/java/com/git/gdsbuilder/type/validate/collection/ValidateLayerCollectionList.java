...
public class ValidateLayerCollectionList {
	...
	/**
	 * validateLayerTypeList getter
	 * @author DY.Oh
	 * @Date 2017. 3. 11. 오후 2:56:14
	...
	/**
	 * validateLayerTypeList setter
	 * @author DY.Oh
	 * @Date 2017. 3. 11. 오후 2:56:16
	 * @param validateLayerTypeList void
	 * @throws
	 * */
		...
		for (int j = 0; j < validateLayerTypeList.size(); j++) {
			...
			if (type.getTypeName().equals(typeName)) {
				...
				for (int i = 0; i < names.size(); i++) {
					...
					System.out.println(layers.add(geoLayer));
					layers.add(geoLayer);
				}
			}
		}

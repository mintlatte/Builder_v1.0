 ...
 * */
public class EditayerCollectionListParser {
	 ...
	 */
	public EditayerCollectionListParser(JSONObject collectionListObj)
	 ...
	 * @throws
	 * */
	public void collectionListParse() throws FileNotFoundException, IOException, ParseException, SchemaException {
		...
		while(editCollections.hasNext()) {
			...
			EditLayerCollectionParser collectionParser = new EditLayerCollectionParser(collectionObj);
